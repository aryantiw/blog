...
<html lang="en"><head>
  ...
  <meta property="og:site_name" content="Scientifically Yours"><meta property="og:type" content="${jsonLd['@type'] === 'Article' ? 'article' : 'website'}">
...
const homeHeader = header({ title: 'Scientifically Yours | Aryan Tiwari', description: 'Essays on existence, science, philosophy, desire, humanity, and the questions that shape us.', canonical: siteUrl, jsonLd: { '@context': 'https://schema.org', '@type': 'Blog', name: 'Scientifically Yours', url: siteUrl, author: { '@type': 'Person', name: 'Aryan Tiwari' } } });
...
await Promise.all(posts.map(async (post, index) => {
  ...
  const article = `${header({ title: `${post.title} | Scientifically Yours`, description: post.description, canonical, css: '../css/', jsonLd: { '@context': 'https://schema.org', '@type': 'Article', headline: post.title, description: post.description, datePublished: post.pubDate, author: { '@type': 'Person', name: post.author }, mainEntityOfPage: canonical } })}
